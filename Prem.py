...
# Decompiled from: Python 3.10.0 (default, Oct 31 2021, 01:09:05) [Clang 12.0.8 (https://android.googlesource.com/toolchain/llvm-project c935d99d7
        ...
        with requests.Session() as (ses_):
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '*' + h + ']' + p + ' Status:' + h + ' Premium Lah*'
            except NameError:
                print h + ' [' + k + '*' + h + ']' + p + ' Status:' + h + ' Premium*'
            ...
            try:
                ...
                if pilih == '17':
                    ...
                    id__ = str(random.randint(111111, 999999999999999))
